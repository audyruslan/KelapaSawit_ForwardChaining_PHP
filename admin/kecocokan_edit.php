  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
      <div class="btn-group mr-2">
        ...
        <button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalKriteria">
          Lihat Kriteria
        </button>
        ...
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalAlternatif">
          Lihat Alternatif
        </button>
      ...
      <a href="kecocokan.php" class="btn btn-sm btn-info pull-right"><i class="fa fa-arrow-left"></i> KEMBALI</a>
    </div>
  </div>
